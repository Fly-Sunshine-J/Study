...
-  (IBAction)nextClicked:(id)sender
{
    ...
    if (self.calendar.scope == FSCalendarScopeWeek) {
        nextMonth = [self.gregorian dateByAddingUnit:NSCalendarUnitWeekOfMonth value:1 toDate:self.calendar.currentPage options:0];
    }else {
        nextMonth = [self.gregorian dateByAddingUnit:NSCalendarUnitMonth value:1 toDate:self.calendar.currentPage options:0];
    }
