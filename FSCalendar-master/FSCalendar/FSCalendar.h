...
/**
 ...
 - FSCalendarScopeMonth: 查看范围是月份
 - FSCalendarScopeWeek: 查看范围是周
 */
...
/**
 ...
 - FSCalendarScrollDirectionVertical: 垂直方向
 - FSCalendarScrollDirectionHorizontal: 水平方向
 */
...
/**
 ...
 - FSCalendarPlaceholderTypeNone: 没有占位符
 - FSCalendarPlaceholderTypeFillHeadTail: 前后补齐
 - FSCalendarPlaceholderTypeFillSixRows: 6行补齐
 */
 ...
 * 日历组件的字体和颜色搭配，如果想使用一个全局的主题，可以使用FSCalendarAppearance这个类，如果想具体到某一个时间点需要不同的主题，使用FSCalendarDelegateAppearance代理
 *
 * @see FSCalendarAppearance
 */
 ...
 * 如果是显示周的模式，代表当前可见的周日期，如果是月份模式，代表当前可见的月日期
 */
 ...
 * 不同的日历视野范围，周和月份之间改变的时候会引起frame的变化
 *
 *    - (void)calendar:(FSCalendar *)calendar boundingRectWillChange:(CGRect)bounds animated:(BOOL)animated;
 */
...
/**
 ...
 如果pagingEnabled是NO的时候 rowHeight有作用
 */
...
/**
 ...
 使用FSCalendarAppearance对象控制日历的全局主题
 */
...
/**
 ...
 如果可见范围是周，可展示日期所在的周，如果可见范围是月份，可展示日期所在的月份
