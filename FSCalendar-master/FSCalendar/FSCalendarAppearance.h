...
/**
 FSCalendarCell的状态，枚举类型
 */
typedef NS_ENUM(NSInteger, FSCalendarCellState) {
    FSCalendarCellStateNormal      = 0,             //正常状态
    FSCalendarCellStateSelected    = 1,             //选择状态
    FSCalendarCellStatePlaceholder = 1 << 1,        //占位符状态
    FSCalendarCellStateDisabled    = 1 << 2,        //不可用状态
    FSCalendarCellStateToday       = 1 << 3,        //今天的状态
    FSCalendarCellStateWeekend     = 1 << 4,        //星期的状态
    FSCalendarCellStateTodaySelected = FSCalendarCellStateToday|FSCalendarCellStateSelected     //今天选中的状态
};
...
/**
 ...
 - FSCalendarSeparatorNone: 没有分割线
 - FSCalendarSeparatorInterRows: 行分割线
 */
